...
const electronHandler = {
  ...
  eventDB: {
    ...
    getEventName: eventDB.getEventName,
  ...
  heatRaceDB: {
    ...
    swapRaceResults: heatRaceDB.swapRaceResults,
    getHeatDetails: heatRaceDB.getHeatDetails,
    updateRDGScores: heatRaceDB.updateRDGScores,
